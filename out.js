(function(global, factory) {
    ...
    function isArrayLike(obj) {
        ...
        return type === "array" || length === 0 || typeof length === "number" && length > 0 &&(length - 1)
         in obj;
    }
    var Sizzle = (function(window) {
            ...
            if (!seed) {
                ...
                if (documentIsHTML) {
                    if (nodeType !== 11 &&(match = rquickExpr.exec(selector))) {
                        ...
                        elseif ((m = match[3]) && support.getElementsByClassName && context.getElementsByClassName) {
        ...
        setDocument = Sizzle.setDocument = function(node) {
            ...
            if ((support.qsa = rnative.test(document.querySelectorAll))) {
                assert(function(el) {
                    docElem.appendChild(el).innerHTML = "<a id='" + expando + "'></a>" + "<select id='" + expando + "-\r\' msallowcapture=''>" + "<option selected=''></option></select>";
        ...
        Expr = Sizzle.selectors = {
            cacheLength: 50, createPseudo: markFunction, match: matchExpr, attrHandle: {}, find: {}, relative: {
                ...
                "ATTR": function(match) {
                    ...
                    elseif (unquoted && rpseudo.test(unquoted) &&(excess = tokenize(unquoted, true)) &&(excess = unquoted.indexOf(")", unquoted.length - excess) - unquoted.length)) {
                ...
                if (xml) {
                    ...
                    while((elem = elem[dir])) {
                        if (elem.nodeType === 1 || checkNonElements) {
                            ...
                            elseif ((oldCache = uniqueCache[key]) && oldCache[0] === dirruns && oldCache[1] === doneName) {
    ...
    var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init = jQuery.fn.init = function(selector, context, root) {
        ...
        if (typeof selector === "string") {
            ...
            if (match &&(match[1] ||!context)) {
                if (match[1]) {
                    context = contextinstanceof jQuery ? context[0]: context;
    ...
    function getAll(context, tag) {
        ...
        elseif (typeof context.querySelectorAll !== "undefined") {
    ...
    Tween.propHooks = {
        _default: {
            get: function(tween) {
                ...
                elseif (tween.elem.nodeType === 1 &&(tween.elem.style[jQuery.cssProps[tween.prop]] != null || jQuery.cssHooks[tween.prop])) {
    ...
    jQuery.extend({
        active: 0, lastModified: {}, etag: {}, ajaxSettings: {
            url: location.href, type: "GET", isLocal: rlocalProtocol.test(location.protocol), global: true, processData: true, async: true, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {
            ...
            elseif (s.data && s.processData &&(s.contentType || "").indexOf("application/x-www-form-urlencoded") === 0) {
    ...
    jQuery._evalUrl = function(url) {
        return jQuery.ajax({
            url: url, type: "GET", dataType: "script", cache: true, async: false, global: false, "throws": true
        });
    };
    jQuery.fn.extend({
    ...
    jQuery.fn.load = function(url, params, callback) {
        ...
        elseif (params && typeof params === "object") {
            type = "POST";
        }
        if (self.length > 0) {
            jQuery.ajax({
