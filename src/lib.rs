    ...
    fn check_for_expression(token: &RawToken) -> bool {
        match token {
            RawToken::Punct(p) => match p {
                ...
                Punct::Assign => true,
                Punct::AddAssign => true,
                Punct::SubtractAssign => true,
                Punct::MultiplyAssign => true,
                Punct::ExponentAssign => true,
                Punct::DivideAssign => true,
                Punct::ModuloAssign => true,
                Punct::LeftShiftAssign => true,
                Punct::RightShiftAssign => true,
                Punct::UnsignedRightShiftAssign => true,
                Punct::BitwiseAndAssign => true,
                Punct::BitwiseOrAssign => true,
                Punct::BitwiseXOrAssign => true,
                Punct::Comma => true,
                Punct::Plus => true,
                Punct::Minus => true,
                Punct::Asterisk => true,
                ...
                Punct::Modulo => true,
                Punct::Increment => true,
                Punct::Decrement => true,
