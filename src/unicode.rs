    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    satisfy(|c: char| {
        ...
        (raw_char >= 97 && raw_char <= 122)
            ...
            || (raw_char >= 119_834 && raw_char <= 119_859)
            || (raw_char >= 119_886 && raw_char <= 119_892)
            || (raw_char >= 119_894 && raw_char <= 119_911)
            || (raw_char >= 119_938 && raw_char <= 119_963)
            || (raw_char >= 119_990 && raw_char <= 119_993)
            || raw_char == 119_995
            || (raw_char >= 119_997 && raw_char <= 120_003)
            || (raw_char >= 120_005 && raw_char <= 120_015)
            || (raw_char >= 120_042 && raw_char <= 120_067)
            || (raw_char >= 120_094 && raw_char <= 120_119)
            || (raw_char >= 120_146 && raw_char <= 120_171)
            || (raw_char >= 120_198 && raw_char <= 120_223)
            || (raw_char >= 120_250 && raw_char <= 120_275)
            || (raw_char >= 120_302 && raw_char <= 120_327)
            || (raw_char >= 120_354 && raw_char <= 120_379)
            || (raw_char >= 120_406 && raw_char <= 120_431)
            || (raw_char >= 120_458 && raw_char <= 120_485)
            || (raw_char >= 120_514 && raw_char <= 120_538)
            || (raw_char >= 120_540 && raw_char <= 120_545)
            || (raw_char >= 120_572 && raw_char <= 120_596)
            || (raw_char >= 120_598 && raw_char <= 120_603)
            || (raw_char >= 120_630 && raw_char <= 120_654)
            || (raw_char >= 120_656 && raw_char <= 120_661)
            || (raw_char >= 120_688 && raw_char <= 120_712)
            || (raw_char >= 120_714 && raw_char <= 120_719)
            || (raw_char >= 120_746 && raw_char <= 120_770)
            || (raw_char >= 120_772 && raw_char <= 120_777)
            || raw_char == 120_779
    })
}
    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    satisfy(|c: char| {
        ...
        (raw_char >= 768 && raw_char <= 879)
            ...
            || (raw_char >= 113_821 && raw_char <= 113_822)
            || (raw_char >= 119_143 && raw_char <= 119_145)
            || (raw_char >= 119_163 && raw_char <= 119_170)
            || (raw_char >= 119_173 && raw_char <= 119_179)
            || (raw_char >= 119_210 && raw_char <= 119_213)
            || (raw_char >= 119_362 && raw_char <= 119_364)
            || (raw_char >= 121_344 && raw_char <= 121_398)
            || (raw_char >= 121_403 && raw_char <= 121_452)
            || raw_char == 121_461
            || raw_char == 121_476
            || (raw_char >= 121_499 && raw_char <= 121_503)
            || (raw_char >= 121_505 && raw_char <= 121_519)
            || (raw_char >= 122_880 && raw_char <= 122_886)
            || (raw_char >= 122_888 && raw_char <= 122_904)
            || (raw_char >= 122_907 && raw_char <= 122_913)
            || (raw_char >= 122_915 && raw_char <= 122_916)
            || (raw_char >= 122_918 && raw_char <= 122_922)
            || (raw_char >= 125_136 && raw_char <= 125_142)
            || (raw_char >= 125_252 && raw_char <= 125_258)
    })
}
    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    satisfy(|c: char| {
        ...
        raw_char == 2307
            ...
            || (raw_char >= 119_141 && raw_char <= 119_142)
    })
}
    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    satisfy(|c: char| {
        ...
        (raw_char >= 65 && raw_char <= 90)
            ...
            || (raw_char >= 119_808 && raw_char <= 119_833)
            || (raw_char >= 119_860 && raw_char <= 119_885)
            || (raw_char >= 119_912 && raw_char <= 119_937)
            || raw_char == 119_964
            || (raw_char >= 119_966 && raw_char <= 119_967)
            || raw_char == 119_970
            || (raw_char >= 119_973 && raw_char <= 119_974)
            || (raw_char >= 119_977 && raw_char <= 119_980)
            || (raw_char >= 119_982 && raw_char <= 119_989)
            || (raw_char >= 120_016 && raw_char <= 120_041)
            || (raw_char >= 120_068 && raw_char <= 120_069)
            || (raw_char >= 120_071 && raw_char <= 120_074)
            || (raw_char >= 120_077 && raw_char <= 120_084)
            || (raw_char >= 120_086 && raw_char <= 120_092)
            || (raw_char >= 120_120 && raw_char <= 120_121)
            || (raw_char >= 120_123 && raw_char <= 120_126)
            || (raw_char >= 120_128 && raw_char <= 120_132)
            || raw_char == 120_134
            || (raw_char >= 120_138 && raw_char <= 120_144)
            || (raw_char >= 120_172 && raw_char <= 120_197)
            || (raw_char >= 120_224 && raw_char <= 120_249)
            || (raw_char >= 120_276 && raw_char <= 120_301)
            || (raw_char >= 120_328 && raw_char <= 120_353)
            || (raw_char >= 120_380 && raw_char <= 120_405)
            || (raw_char >= 120_432 && raw_char <= 120_457)
            || (raw_char >= 120_488 && raw_char <= 120_512)
            || (raw_char >= 120_546 && raw_char <= 120_570)
            || (raw_char >= 120_604 && raw_char <= 120_628)
            || (raw_char >= 120_662 && raw_char <= 120_686)
            || (raw_char >= 120_720 && raw_char <= 120_744)
            || raw_char == 120_778
    })
}
    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    satisfy(|c: char| {
        ...
        (raw_char >= 48 && raw_char <= 57)
            ...
            || (raw_char >= 120_782 && raw_char <= 120_831)
    })
}
    ...
    I::Error: ParseError<I::Item, I::Range, I::Position>,
{
    c_char('\\')
        .and(escape_sequence())
        .map(|(_, sequence): (char, String)| format!("\\u{{{0}}}", &sequence[1..]).parse().unwrap())
}
