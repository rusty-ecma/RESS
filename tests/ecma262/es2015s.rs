...
"
        ...
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::no_sub_template("a", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::template_head("", false, false)),
        Token::Number("0".into()),
        Token::Template(Template::template_tail("", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::template_head("0", false, false)),
        Token::Number("0".into()),
        Token::Punct(Punct::Comma),
        Token::Number("1".into()),
        Token::Template(Template::template_tail("2", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::template_head("0", false, false)),
        Token::Template(Template::template_head("1", false, false)),
        Token::Number("2".into()),
        Token::Template(Template::template_tail("3", false, false)),
        Token::Template(Template::template_tail("4", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::no_sub_template(r"\`", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Template(Template::no_sub_template(r"a\${b", false, false)),
        Token::Punct(Punct::SemiColon),
        ...
        Token::Punct(Punct::OpenParen),
        Token::Punct(Punct::CloseParen),
        Token::Template(Template::no_sub_template("template", false, false)),
        Token::Punct(Punct::SemiColon),
        Token::Punct(Punct::OpenParen),
        Token::Punct(Punct::CloseParen),
        Token::Punct(Punct::EqualGreaterThan),
