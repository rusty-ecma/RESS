...
lazy_static! {
    pub static ref TOKENS: Vec<RefToken<'static>> =
        ...
        RefToken::Punct(Punct::Comma),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Ident("i8".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("as".into()),
        RefToken::Ident("i9".into()),
        RefToken::Punct(Punct::CloseBrace),
        RefToken::Ident("from".into()),
        RefToken::String(StringLit::double("module")),
        RefToken::Punct(Punct::SemiColon),
...
"
        ...
        RefToken::Punct(Punct::Comma),
        RefToken::Ident(r"x\u{e01d5}".into()),
        RefToken::Punct(Punct::Comma),
        ...
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("䩶".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("x󠇕".into()),
        RefToken::Punct(Punct::Comma),
        ...
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Let),
        RefToken::Ident("letx".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Let),
        RefToken::Punct(Punct::OpenBracket),
        RefToken::Ident(r"x\u0078".into()),
        RefToken::Punct(Punct::CloseBracket),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Const),
        RefToken::Ident("constx".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Punct(Punct::OpenBrace),
        ...
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0b0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0B0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0b01".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0b10".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0b10101010".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0o0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0O0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0o01234567".into()),
        RefToken::Punct(Punct::SemiColon),
...
"
        ...
        RefToken::Punct(Punct::Colon),
        RefToken::Ident("h".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("i".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("i".into()),
        RefToken::Punct(Punct::Colon),
        RefToken::Ident("j".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::CloseBrace),
        RefToken::Punct(Punct::Comma),
        RefToken::Punct(Punct::Ellipsis),
        RefToken::Ident("k".into()),
        RefToken::Punct(Punct::CloseParen),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Punct(Punct::CloseBrace),
        RefToken::Punct(Punct::Comma),
        ...
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x1".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("y2".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x3".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("y4".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("z5".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x6".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x7".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("y8".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x9".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("y10".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("x11".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("y12".into()),
        RefToken::Punct(Punct::Equal),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Punct(Punct::SemiColon),
        ...
        RefToken::Punct(Punct::OpenParen),
        RefToken::Keyword(Keyword::Var),
        RefToken::Ident("a1".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("b2".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0".into()),
        RefToken::Punct(Punct::SemiColon),
        RefToken::Number("0".into()),
        ...
        RefToken::Punct(Punct::SemiColon),
        RefToken::Keyword(Keyword::Function),
        RefToken::Ident("f2".into()),
        RefToken::Punct(Punct::OpenParen),
        RefToken::Punct(Punct::CloseParen),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Punct(Punct::CloseBrace),
        RefToken::Keyword(Keyword::Function),
        RefToken::Ident("f3".into()),
        RefToken::Punct(Punct::OpenParen),
        RefToken::Ident("x".into()),
        RefToken::Punct(Punct::CloseParen),
        RefToken::Punct(Punct::OpenBrace),
        ...
        RefToken::Punct(Punct::CloseBrace),
        RefToken::Keyword(Keyword::Function),
        RefToken::Ident("f5".into()),
        RefToken::Punct(Punct::OpenParen),
        RefToken::Punct(Punct::CloseParen),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Keyword(Keyword::Function),
        RefToken::Ident("f6".into()),
        RefToken::Punct(Punct::OpenParen),
        RefToken::Punct(Punct::CloseParen),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Punct(Punct::CloseBrace),
        ...
        RefToken::Ident("A".into()),
        RefToken::Punct(Punct::OpenBrace),
        RefToken::Ident("constructor".into()),
        RefToken::Punct(Punct::OpenParen),
        RefToken::Ident("a".into()),
        RefToken::Punct(Punct::Comma),
        RefToken::Ident("b".into()),
